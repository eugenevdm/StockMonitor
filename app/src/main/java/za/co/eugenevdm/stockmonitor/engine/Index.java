...
public enum Index {
    ...
    DAX(Country.Germany, "DAX", "Deutsche Borse AG German StockObject Index", Code.newInstance("^GDAXI")),
    ...
    NSEI(Country.India, "NIFTY", "National StockObject Exchange CNX Nifty Index", Code.newInstance("^NSEI")),
    ...
    KS11(Country.Korea, "KOSPI", "Korea StockObject Exchange KOSPI Index", Code.newInstance("^KS11")),
    ...
    OSEAX(Country.Norway, "OSEBX", "Oslo StockObject Exchange Benchmark Index", Code.newInstance("^OSEAX")),
    ...
    TWII(Country.Taiwan, "TSEC", "Taiwan StockObject Exchange Weighted Index", Code.newInstance("^TWII")),
