...
import za.co.eugenevdm.stockmonitor.engine.Country;
...
//import za.co.eugenevdm.stockmonitor.engine.currency.CurrencyPair;
import za.co.eugenevdm.stockmonitor.file.GUIBundleWrapper;
import za.co.eugenevdm.stockmonitor.file.Statement;
//import za.co.eugenevdm.stockmonitor.file.Statements;
//import za.co.eugenevdm.stockmonitor.gui.JStockOptions;
...
//        File stockPricesFile = new File(za.co.eugenevdm.stockmonitor.portfolio.Utils.getStockPricesFilepath());
//
...
//        za.co.eugenevdm.stockmonitor.engine.currency.Currency c = portfolioRealTimeInfo.currencies.get(code);
//        if (c == null) {
//            Country stockCountry = za.co.eugenevdm.stockmonitor.engine.Utils.toCountry(code);
...
//        return za.co.eugenevdm.stockmonitor.gui.Utils.getUserDataDirectory() + country + File.separator + "portfolios" + File.separator + name + File.separator;
//    }
//
//    private static String getPortfolioRealTimeInfoFilepath(Country country, String name) {
//        final String portfolioDirectory = za.co.eugenevdm.stockmonitor.portfolio.Utils.getPortfolioDirectory(country, name);
...
//        }
//
//        if (false == za.co.eugenevdm.stockmonitor.gui.Utils.createCompleteDirectoryHierarchyIfDoesNotExist(directory)) {
//            return false;
//        }
//
...
//            final File file = new File(za.co.eugenevdm.stockmonitor.gui.Utils.getUserDataDirectory() + country + File.separator + "portfolios" + File.separator);
...
//                        int lines = za.co.eugenevdm.stockmonitor.gui.Utils.numOfLines(stockPricesFile, true);
//                        // Skip CSV header.
//                        lines = lines - 1;
//                        if (lines > 0) {
//                            PortfolioInfo portfolioInfo = PortfolioInfo.newInstance(country, child.getName(), lines);
...
//                    int lines = za.co.eugenevdm.stockmonitor.gui.Utils.numOfLines(sellPortfolioFile, true);
//                    // Skip CSV header.
//                    lines = lines - 1;
//                    if (lines > 0) {
//                        PortfolioInfo portfolioInfo = PortfolioInfo.newInstance(country, child.getName(), lines);
...
//                    lines = za.co.eugenevdm.stockmonitor.gui.Utils.numOfLines(dividendFile, true);
//                    // Skip CSV header.
//                    lines = lines - 1;
//                    if (lines > 0) {
//                        PortfolioInfo portfolioInfo = PortfolioInfo.newInstance(country, child.getName(), lines);
...
//                    lines = za.co.eugenevdm.stockmonitor.gui.Utils.numOfLines(depositFile, true);
//                    // Skip CSV header.
//                    lines = lines - 1;
//                    if (lines > 0) {
//                        PortfolioInfo portfolioInfo = PortfolioInfo.newInstance(country, child.getName(), lines);
