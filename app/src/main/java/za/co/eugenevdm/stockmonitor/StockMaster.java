...
public class StockMaster {
    ...
    public StockMaster(StockMaster stock) {
     ...
     * specified name.
     */
    public StockMaster deriveStock(String name) {
     ...
     * specified symbol.
     */
    public StockMaster deriveStock(Symbol symbol) {
        return new StockMaster(
                this.code,
                symbol,
                this.name,
